...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-09-2026 a las 02:54:56
...
INSERT INTO `mantenimiento` (`id`, `id_chofer`, `id_tecnico_asignado`, `id_vehiculo`, `tipo_falla`, `comentario`, `trabajo_realizado`, `estado_mantenimiento`, `fecha`) VALUES
(1, 2, 47, 7, 'Correctiva', 'motor recalentado', 'motor reparado', 'Finalizado', '2026-09-10 19:56:51');
...
(55, 'Victoria Peña', '123', 'Administrador', 'vpeña');
...
--
-- Volcado de datos para la tabla `usuarios_historicos`
--

INSERT INTO `usuarios_historicos` (`id`, `id_usuario_original`, `nombres`, `usuario`, `contraseña`, `cargo`, `eliminado_por`, `comentario`, `fecha_eliminacion`) VALUES
(1, 53, 'Victoria Peña', 'Vpeña', '$2y$10$HxyC01tEEGm.d', 'Administrador', 'Administrador General', 'Renuncia', '2026-09-10 20:19:41'),
(2, 54, 'Victoria Peña', 'vpeña', '$2y$10$/RlhcMAh9jq6s', 'Administrador', 'Administrador General', 'Renuncia', '2026-09-10 20:35:51');
